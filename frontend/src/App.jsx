...
const fallbackPortfolio = {
  name: "Mayank Singh",
  role: "Software Development| Full-Stack with specialization in Backend",
...
function TypingHeading() {
  ...
  return (
    <span className="inline-flex min-h-8  w-25.5 items-center text-2xl font-semibold text-black sm:text-lg">
  ...
  return (
    <main className="min-h-screen bg-stone-50 font-display text-zinc-950">
      ...
      <div className="sticky top-0 z-40 flex min-h-12 items-center justify-center bg-zinc-950 px-4 text-center text-xs font-bold uppercase tracking-[0.18em] text-white sm:text-sm">
        Open to Software development | Full stack Projects
      </div>
      ...
      <section id="home" className="mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:px-8 sm:py-20 lg:grid-cols-[1.1fr_0.9fr] lg:px-12">
        ...
        <motion.div
          className="relative overflow-hidden rounded-[2rem] bg-zinc-950 p-6 text-white shadow-2xl"
        ...
        >
          ...
          <div className="flex h-full flex-col justify-between">
            ...
            <div>
              <span className="rounded-full bg-emerald-500 px-4 py-2 text-sm font-bold">
                Resume
              </span>
            ...
            <div className="mt-10 flex gap-3">
              ...
              <a
                href="/resume.pdf"
                download
                className="rounded-full border border-zinc-600 px-5 py-3 font-bold"
              >
                Download PDF
              </a>
      ...
      <section className="border-t border-zinc-200 px-5 py-16 sm:px-8 lg:px-12" id="dsa">
        <div className="mx-auto max-w-7xl">
          <SectionHeading
            kicker="Problem Solving"
            title="Algorithms, contests, and consistent improvement."
          />

          <div className="grid gap-5 lg:grid-cols-[1fr_320px]">

            <motion.p
              className="rounded-3xl border border-zinc-300 bg-white p-7 text-xl leading-9 text-black shadow-sm sm:p-9"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              viewport={{ amount: 0.4 }}
            >
              I enjoy solving algorithmic problems that demand careful reasoning,
              efficient implementation, and pattern recognition. Regular participation
              in coding contests has strengthened my understanding of data structures,
              dynamic programming, graphs, greedy techniques, and optimization
      ...
      <section className="border-t border-zinc-200 px-5 py-16 sm:px-8 lg:px-12" id="intro">
        <div className="mx-auto max-w-7xl">
          <SectionHeading kicker="Project building" title="Full-stack projects with motion, structure, and intent." />
          <div className="grid gap-5 lg:grid-cols-[1fr_320px]">
            <motion.p
              className="rounded-3xl  border border-zinc-300 bg-white p-7 text-xl leading-9 text-black shadow-sm sm:p-9"
              initial={{ opacity: 0 }}
              ...
              viewport={{ amount: 0.4 }}
            >
              My focus is building practical, fast, and polished applications: React on the front along with tailwind,
              Express and Node on the back, and MongoDB or Postgres for the data layer. I like interfaces that move
              with purpose and APIs that stay clean under pressure.
            </motion.p>
            <div className="rounded-3xl border border-zinc-300 bg-emerald-50 p-7">
              <span className="text-6xl font-black text-red-800">22</span>
              <p className="mt-5 text-lg leading-7 text-black">public GitHub repositories connected through one profile.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="overflow-hidden border-t border-zinc-300 bg-zinc-950 px-5 py-16 text-white sm:px-8 lg:px-12" id="skills">
        <div className="mx-auto max-w-7xl">
          <SectionHeading kicker="Skills" title="From algorithms to applications, engineering software with purpose." align="right" tone="dark" />
                  ...
                  <div className="flex w-full flex-col">
                    ...
                    <div className="flex min-h-80 flex-1 flex-col p-6">
                      ...
                      <div className="mt-auto flex flex-wrap gap-2 pt-8">
                        ...
                        {project.name === "Codeforces" || project.name === "LeetCode" ? (
                          <a
                            className="inline-flex items-center gap-2 bg-black text-white rounded-full border border-zinc-300 px-4 py-3 text-sm font-bold transition hover:border-zinc-950"
                            href={project.href}
                            target="_blank"
                            rel="noreferrer"
                          >
